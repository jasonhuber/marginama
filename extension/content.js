...
(function () {
  ...
  shadow.innerHTML = `
    <style>
      ...
      .ts-row button:hover { background: #e5e7eb; }
      textarea {
        width: 100%;
        min-height: 70px;
        resize: vertical;
      ...
      .note .jump:hover { background: #000000; }
      .note .text {
        flex: 1;
        font-size: 12px;
        color: #1f2937;
      ...
      .config-hint a { color: #92400e; text-decoration: underline; }
      .overlay-toggle {
        display: flex;
        align-items: center;
        gap: 6px;
      ...
      .overlay-toggle:hover { background: #e5e7eb; }
      .overlay-toggle input { margin: 0; cursor: pointer; }
      .reviewer-picker {
        display: flex;
        align-items: center;
        gap: 6px;
